...
int glWindowSizeX = 1920;
int glWindowSizeY = 1080;
...
int main(void)
{
    ...
    GLFWwindow* pWindow = glfwCreateWindow(glWindowSizeX, glWindowSizeY, "Galina Engine", glfwGetPrimaryMonitor(), nullptr);
    if (!pWindow)
    {
        glfwTerminate();
        return -1;
